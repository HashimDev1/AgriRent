  ...
  try {
    ...
    const equipments = await Equipment.insertMany([
      ...
      },
      {
        ...
        images: ['https://res.cloudinary.com/hashim055/image/upload/v1781213242/agrirent/equipment/qkpoir3bhtpwv4txpzfk.jpg'],
        location: { type: 'Point', coordinates: [72.6711, 32.0836], address: 'Main Bazaar Road', city: 'Sargodha' },
        availability: { startDate: new Date(), endDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000) },
        status: 'approved',
        isAvailable: true,
      },
      {
        ...
        images: ['https://res.cloudinary.com/hashim055/image/upload/v1781213105/agrirent/equipment/kucspae23hdcy3ik7h66.jpg'],
        location: { type: 'Point', coordinates: [72.6711, 32.0836], address: 'Main Bazaar Road', city: 'Sargodha' },
        availability: { startDate: new Date(), endDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000) },
      ...
      },
      {
        ...
        images: ['https://res.cloudinary.com/hashim055/image/upload/v1781213594/agrirent/equipment/drk4enx7jtqr1jehlntv.jpg'],
      ...
      },
      {
        ...
        images: ['https://res.cloudinary.com/hashim055/image/upload/v1781214084/agrirent/equipment/h8ajkf6701z5sfaizbel.jpg'],
        location: { type: 'Point', coordinates: [73.1022, 30.6622], address: 'Multan Road Bypass', city: 'Sahiwal' },
        availability: { startDate: new Date(), endDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000) },
        status: 'approved',
        isAvailable: true,
      },
      {
        ...
        rentPerDay: 3000,
        securityDeposit: 5000,
        images: ['https://res.cloudinary.com/hashim055/image/upload/v1781214112/agrirent/equipment/i5ljph4awtdsx3ppdci8.jpg'],
        location: { type: 'Point', coordinates: [73.1022, 30.6622], address: 'Multan Road Bypass', city: 'Sahiwal' },
        availability: { startDate: new Date(), endDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000) },
        status: 'pending_verification',
        isAvailable: true,
    ...
    await Dispute.insertMany([
      {
        ...
        evidenceImages: ['https://res.cloudinary.com/hashim055/image/upload/v1781213127/agrirent/equipment/kluhscvibk8ox0kflrox.jpg'],
        status: 'open',
      },
      {
